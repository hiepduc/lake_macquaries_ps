...
wrf_files = sorted(
    glob.glob("/mnt/scratch_lustre/ar_policy/whe_project/esme_local/wrf_cu_gmr_2023/run/WRF/run/wrfout_d02_2023-01*")
)
...
csv_files = sorted(
    glob.glob("ceilodata/L3_DEFAULT__202301*_Merriwa.csv")
)
