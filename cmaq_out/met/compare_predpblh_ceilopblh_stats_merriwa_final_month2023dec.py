...
wrf_files = sorted(
    glob.glob("/mnt/scratch_lustre/ar_policy/whe_project/esme_local/wrf_cu_gmr_2023/run/WRF/run/wrfout_d02_2023-12*")
)
...
csv_files = sorted(
    glob.glob("ceilodata/L3_DEFAULT_0_202312*_Merriwa.csv")
)
...
with open("PBLH_statistics_merriwa.txt", "w") as f:
    f.write(stats_text)

print("Saved: PBLH_statistics_merriwa.txt")

# ======================================================
# TIME SERIES
# ======================================================
outfile = "PBLH_WRF_CEILO_merriwa.png"
